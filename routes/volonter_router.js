...
import { dohvatiProfilVolontera, urediProfil, povijestVolontiranja, dohvatiPovijestProfila } from '../controllers/volonter_controllers.js';
...
router.get('/profil/:id/povijest', dohvatiPovijestProfila);
